-- Migration 010: Green Thumb Badge Alias
--
-- Introduces:
-- - green_thumb badge key alias for watering_streak_7
-- - Updates get_badge_progress() to return both watering_streak_7 and green_thumb
-- - Ensures frontend code using green_thumb key gets progress data directly

-- ============================================================================
-- Update get_badge_progress RPC to return green_thumb alias
-- ============================================================================
...
-- ============================================================================
-- Update award_gamification_badges to also award green_thumb badge key
-- ============================================================================
...
BEGIN
  WITH eligible_badges AS (
    ...
    FROM (VALUES
      ...
      -- Add green_thumb alias for watering_streak_7
      ('green_thumb', p_watering_streak >= 7),
